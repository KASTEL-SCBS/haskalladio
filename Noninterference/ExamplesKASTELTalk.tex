...
\begin{center}
  \adjustbox{valign=t}{\resizebox{!}{\exheight}{\exampleOneWithSpecWeakMono}}
  \adjustbox{valign=t,rlap}{\includegraphics[width=1cm]{img/svg/checkmark.pdf}}
\end{center}
...
\kit{Tatsächlich gilt noch:}
\begin{center}
  \adjustbox{valign=t}{\resizebox{!}{\exheight}{\exampleOneGammaWithSpecWeakMono}}
  \adjustbox{valign=t,rlap}{\includegraphics[width=1cm]{img/svg/checkmark.pdf}}
\end{center}
