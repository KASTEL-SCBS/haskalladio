...
:- dynamic ic/0,car_doesnt_start/1,lights_go_on/1,fuel_indicator_empty/1, broken_indicator/1.
...
abducible_predicate(battery_flat/1).
abducible_predicate(has_no_fuel/1).
abducible_predicate(broken_indicator/1).
